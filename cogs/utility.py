...
from cogs.decktickets import TicketButton
...
class Utility(commands.Cog):
    ...
    async def tickets(self, ctx: commands.Context):
        ...
        embed.set_image(url = 'https://cdn.discordapp.com/attachments/1014919079154425917/1053704189995384892/banner.png')
        embeds.append(embed)
        
        embed = discord.Embed(
            title = "Deck Guide Submission",
            color = 3092790,
            description = "<:information:1034639378410115103> Welcome to the Deck Guide Submission section, managed by our Theorycrafting Staff. We're glad that you're interested in sharing your knowledge of a certain deck or archetype with the rest of the community! However, there are a few things you need to take note of before submitting your deck list and guide.\n"
        )
        embed.description += """
<:information:1034639378410115103> **INFORMATION**
For a guide to be approved to be displayed in <#1051465686062469203>, it must meet certain standards of quality:

<:blurpleannouncement:1020402170127982712> **INSTRUCTIONS**
<:blurplejoinarrow:1053708710003871825> A deck list in image form. For standardization, use the Preview Deck > Share function available in-game to share the deck list infographic generated by the game.
<:blurplejoinarrow:1053708710003871825> A brief mulligan guide. What cards do you keep and redraw in specific matchups?
<:blurplejoinarrow:1053708710003871825> Your overall game plan. What is the primary objective of this deck (e.g. to stall the opponent out, to rush them down, to setup a specific combo) and how does it vary in different situations?
<:blurplejoinarrow:1053708710003871825> An outline of the key cards in your deck. Why these specific card choices, and what do they do to advance your overall game plan?
<:blurplejoinarrow:1053708710003871825> Matchup-specific information. How does your deck fare against other decks in the meta? Is it favored against Ganyu Superconduct while losing to Ayamiya OTK? Provide a brief overview of the different matchups you have faced with your deck.

╰・While deck guides are expected to have at least these points covered,  you are free to include any other information you believe would be useful to your readers. Please also note that covering these points does not guarantee that your guide will be approved to be showcased in <#1051465686062469203>, as the discretion for approval remains with the Theorycrafting Staff.
        """
        embed.set_thumbnail(url = 'https://cdn.discordapp.com/attachments/1014919079154425917/1053708316540407828/icon.png')
        embeds.append(embed)
        
        return await ctx.send(
            embeds = embeds,
            view = discord.ui.View(timeout = None).add_item(TicketButton(ctx))
        )
